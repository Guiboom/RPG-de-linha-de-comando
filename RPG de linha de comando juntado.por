programa {
  funcao inicio() {
    ...
    escreva("Mais antes voce vai dar uma parada no posto de combustível.\n")
    ...
    escreva("Você dirigiu pela estrada de terra. Durante a viagem o seu carro atolou! Você quer chamar o guincho ou comprar uma roleta\nda sorte por R$80 com 50% de chace de avançar para o próximo checkpoint e 50% de chance de perder?\n")
    leia(desicao)}
